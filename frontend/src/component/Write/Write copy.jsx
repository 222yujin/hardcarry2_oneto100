...
import nocheck from "../../assets/nocheckbox.jpg";
import incheck from "../../assets/incheckbox.png";
            ...
            <div className={styles.diaryscope}>
              <form className={styles.form} onSubmit={handleSubmit}>
                <div className={styles.submitdiaryscope}>
                  ...
                  <p className={styles.write_inform}>
                ...
                <div className={styles.write_private}>
                  <div className={styles.submit_kkk}>
                    <input
                      ...
                      placeholder="(선택) 연락처 적고 경품 받기"
                    />
                    <span className={styles.write_privateperson}>
                      {" "}
                      개인정보 활용동의
                    </span>
                  </div>{" "}
